...
var FrappeApp = /** @class */ (function () {
    function FrappeApp(url, tokenParams, name) {
        var _a, _b;
        this.url = url;
        ...
        this.axios = (0, axios_1.getAxiosClient)(this.url, this.useToken, this.token, this.tokenType);
    }
    ...
    FrappeApp.prototype.file = function () {
        return new file_1.FrappeFileUpload(this.url, this.axios, this.useToken, this.token, this.tokenType);
    };
